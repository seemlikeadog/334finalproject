...
<div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
    ...
    <button class = "btn btn-warning" value="2" onclick="new1(this)"><a href ="http://wang1my.myweb.cs.uwindsor.ca/60334/project/html/adminpage2.php">Edit Second New</a></button>
    <button class = "btn btn-warning" value="3" onclick="new1(this)">Edit Third New</button>

</div>
<br>
<form action="adminpage3.php" method="post">
    ...
    isset($_POST['content']))
{
    ...
    $query    = "UPDATE New SET head = '$head', content = '$content' where id = 3";
